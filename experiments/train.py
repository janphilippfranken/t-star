...
import wandb
from tstar.trainers.trainer import TYPOTrainer
from helpers import *
...
def worker_main(rank: int, world_size: int, args: DictConfig, model):
    ...
    train_dataset = [example for example in train_dataset if example['response_c1_r1_input_ids'].shape[0] <= 2048] # truncate 
